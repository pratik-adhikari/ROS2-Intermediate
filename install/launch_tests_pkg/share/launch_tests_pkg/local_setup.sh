...
: ${AMENT_CURRENT_PREFIX:="/home/user/ros2_ws/install/launch_tests_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/launch_tests_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/launch_tests_pkg/environment/path.sh"
